...
import (
	...
	clusterlogic "github.com/yanshicheng/cloud-back/application/manager-api/internal/logic/cluster"
...
func SearchClusterHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		_ = json.NewEncoder(w).Encode(types.SearchClusterResponse{Items: items, Total: total})
	}
}
