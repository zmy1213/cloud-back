...
import (
	...
	"github.com/yanshicheng/cloud-back/application/manager-api/internal/handler"
	appcfg "github.com/yanshicheng/cloud-back/common/config"
	"github.com/yanshicheng/cloud-back/pkg/config"
)

func main() {
	cfgPath := flag.String("f", "./application/manager-api/etc/manager-api.yaml", "config file path")
	flag.Parse()
