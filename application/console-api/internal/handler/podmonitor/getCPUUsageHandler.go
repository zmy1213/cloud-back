...
func GetCPUUsageHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := podmonitorlogic.NewGetCPUUsageLogic(r.Context(), svcCtx)
		resp, err := l.GetCPUUsage(req)
		if err != nil {
